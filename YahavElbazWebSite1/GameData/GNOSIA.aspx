...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMain" Runat="Server">
    ...
    <div>
        ...
        <ul>
            <li><strong>Day phase:</strong> During the day, players discuss and vote on who they believe the Gnosia are. The player with the most votes is put into "cold sleep."</li>
            <li><strong>Night phase:</strong> At night, the Gnosia secretly choose a victim to eliminate.</li>
